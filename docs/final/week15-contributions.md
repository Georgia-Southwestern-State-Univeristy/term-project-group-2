...
- Implemented and stabilized core gameplay systems (spawning, collision handling, scoring)
- Fixed critical issues identified during triage:
  - Removed debug logs from release code (Main.gd)
  - Enforced non-negative score logic across systems
- Improved UI layout for final resolution (1152×648 scoreboard adjustments)
- Added foundational audio system (AudioStreamPlayer integration and triggers)
...
- Covers final polish and improvements
- Drives live demo

### Rajesh — Project Manager, QA & Documentation
#### Role on Team:
#### Project Manager, QA Lead, Documentation Owner

**Major Contributions Since Beta:**
- Led issue triage and prioritization for final sprint
- Defined and tracked remaining critical/important issues
- Conducted manual testing and validation of gameplay flows
- Verified bug fixes and ensured no regressions before release
- Prepared and finalized project documentation:
  - Sprint plan
  - Presentation plan
...
**Presentation Contribution:**
- Introduces project and goals
- Explains QA process and testing strategy
- Supports reflection and project wrap-up
...
- Narrates live demo (what is happening on screen)
- Shares reflections and lessons learned from a user perspective
