...
Code Standards: Code follows team naming and formatting rules. 
Code is readable and commented if needed

Testing: New functionality includes starter tests

Documentation: Documentation is updated if behavior changes. 
README or feature docs reflect updates
...
Timer is used cleanly, no double-spawn bugs

## Gameplay Behavior and Performance
Feature works at the **target resolution(s)** (1024×600) without UI going off-screen
